...
class TestModelSymbol(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModelSymbol:
        """Test ModelSymbol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelSymbol`
        """
        model = ModelSymbol()
        if include_optional:
            return ModelSymbol(
