...
class ModelDataSource(BaseModel):
    ...
    ModelDataSource
    """ # noqa: E501
    ask_markup: Optional[StrictInt] = None
    bid_markup: Optional[StrictInt] = None
    digits: Optional[StrictInt] = None
    feeder: Optional[StrictStr] = None
    symbol: Optional[StrictStr] = None
    symbols: Optional[List[ModelSymbol]] = None
    __properties: ClassVar[List[str]] = ["ask_markup", "bid_markup", "digits", "feeder", "symbol", "symbols"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ask_markup": obj.get("ask_markup"),
            "bid_markup": obj.get("bid_markup"),
            "digits": obj.get("digits"),
            "feeder": obj.get("feeder"),
...
ModelDataSource.model_rebuild(raise_errors=False)
